...
model = PPO('MlpPolicy', env, verbose=1, tensorboard_log = log_dir, learning_rate=linear_schedule(2.5e-5), gamma=0.96, gae_lambda=0.95, clip_range=0.2, batch_size=32)
