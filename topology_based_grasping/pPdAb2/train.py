...
model = PPO('MlpPolicy', env, verbose=1, tensorboard_log = log_dir, learning_rate=linear_schedule(1.75e-6), gamma=0.98, gae_lambda=0.95, clip_range=0.2, batch_size=32)
